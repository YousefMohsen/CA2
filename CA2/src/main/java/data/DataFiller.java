...
public class DataFiller {
    ...
    public DataFiller() {
        ...
        //persons
        dbf.save(new Person("fn1","ln1",new Hobby("hb1","dsc1"),"em1@",new Address("vej1","ad1",dbf.getCity(7100)),new ArrayList<Phone>(Arrays.asList(new Phone(11,"desc1")))));
        dbf.save(new Person("fn2","ln2",new Hobby("hb2","dsc2"),"em2@",new Address("vej2","ad2",dbf.getCity(877)),new ArrayList<Phone>(Arrays.asList(new Phone(22,"desc2")))));

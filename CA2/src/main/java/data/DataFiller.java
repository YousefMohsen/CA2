...
public class DataFiller {
  ...
  //dbf.save(new Person("fn2","ln2",new Hobby("hb2","dsc2"),"em2",new Address("vej2","ad2",dbf.getCity(3050)),new ArrayList<Phone>(Arrays.asList(new Phone(22,"desc2")))));
      // dbf.save(new Person("fn3","ln3",new Hobby("hb3","dsc3"),"em3",new Address("vej3","ad3",dbf.getCity(555)),new ArrayList<Phone>(Arrays.asList(new Phone(33,"desc3")))));
       dbf.save(new Person("fn4","ln4",new Hobby("hb4","dsc4"),"em4",new Address("vej4","ad4",dbf.getCity(800)),new ArrayList<Phone>(Arrays.asList(new Phone(44,"desc4")))));
